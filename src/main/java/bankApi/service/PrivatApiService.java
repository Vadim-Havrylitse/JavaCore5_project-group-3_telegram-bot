...
public class PrivatApiService implements BaseBankApiInterf {
    ...
    @Override
    public PrivateBankResponse getCurrency(Currency currency) {
    ...
    public CashCurrency getCurrentCurrencyValue(Currency currency) {
        ...
        if (!CashService.getCashCurrencyMap().isEmpty() && CashService.getCashCurrencyMap().containsKey(key)) {
            ...
            PrivateBankResponse bankResponse = getCurrency(currency);
